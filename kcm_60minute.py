        ...
        try:
            ...
            if start_time < now < end_time - datetime.timedelta(hours=1):
                ...
                if (30 > old_old_rsi) and (30 < oldrsi) and (acc_trade_price_24h > 100000000000) and (count1 == 'true' or count2 == 'true' or count3 == 'true') and (upbit.get_balance(coin[4:]) == 0):
                    if count1 == 'true':
                        ...
                        if krw > buy_money_0:
                            ...
                            #구매시간
                            buytime1 = datetime.datetime.now() + datetime.timedelta(minutes=70)
                        ...
                        if krw > buy_money_1:
                            ...
                            count2 = 'false'
                            #구매시간
                            buytime2 = datetime.datetime.now() + datetime.timedelta(minutes=70)
                        ...
                        if krw > buy_money_2:
                            ...
                            count3 = 'false'
                            #구매시간
                            buytime3 = datetime.datetime.now() + datetime.timedelta(minutes=70)
                ...
                if (count1 == 'false') and (oldrsi < 70) and (70 < old_old_rsi) and ((water_buy_price_0) < (get_current_price(buycoin_0))) :
                    ...
                    web1_4 = 'false'
                    web1_5 = 'false'
                if (count1 == 'false') and ((get_current_price(buycoin_0)) > band_high) and ((water_buy_price_0 * 1.02) < (get_current_price(buycoin_0))) :
                    btc_0 = upbit.get_balance(buycoin_0[4:])
                    upbit.sell_market_order(buycoin_0, btc_0)
                    count1 = 'true'
                    web1_1 = 'false'
                ...
                if (count2 == 'false') and (oldrsi < 70) and (70 < old_old_rsi) and ((water_buy_price_1) < (get_current_price(buycoin_1))) :
                    ...
                    web2_4 = 'false'
                    web2_5 = 'false'
                if (count2 == 'false') and ((get_current_price(buycoin_1)) > band_high) and ((water_buy_price_1 * 1.02) < (get_current_price(buycoin_1))) :
                    btc_1 = upbit.get_balance(buycoin_1[4:])
                    upbit.sell_market_order(buycoin_1, btc_1)
                    count2 = 'true'
                    web2_1 = 'false'
                ...
                if (count3 == 'false') and (oldrsi < 70) and (70 < old_old_rsi) and ((water_buy_price_2) < (get_current_price(buycoin_2))) :
                    ...
                    web3_4 = 'false'
                    web3_5 = 'false'
                if (count3 == 'false') and ((get_current_price(buycoin_2)) > band_high) and ((water_buy_price_2 * 1.02) < (get_current_price(buycoin_2))) :
                    btc_2 = upbit.get_balance(buycoin_2[4:])
                    upbit.sell_market_order(buycoin_2, btc_2)
                    count3 = 'true'
                    web3_1 = 'false'
                ...
                if (count2 == 'false') :
                    rsiindex(buycoin_1)
                if (count2 == 'false') and ((water_buy_price_1) < (get_current_price(buycoin_1))) :
                    btc_1 = upbit.get_balance(buycoin_1[4:])
                    upbit.sell_market_order(buycoin_1, btc_1)
                    count2 = 'true'
                    web2_1 = 'false'
                ...
                if (count3 == 'false') :
                    rsiindex(buycoin_2)
                if (count3 == 'false') and ((water_buy_price_2) < (get_current_price(buycoin_2))) :
                    btc_2 = upbit.get_balance(buycoin_2[4:])
                    upbit.sell_market_order(buycoin_2, btc_2)
                    count3 = 'true'
                    web3_1 = 'false'
